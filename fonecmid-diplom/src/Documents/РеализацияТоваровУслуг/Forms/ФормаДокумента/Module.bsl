...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ Матяж А.А. Дипломная работа. Добавление команды "Заполнить"
	Команда = Команды.Добавить("ВКМ_Заполнить");
	Команда.Заголовок = "Заполнить";
	Команда.Действие  = "ВКМ_Заполнить";
	КнопкаФормы = Элементы.Добавить("ВКМ_Заполнить", Тип("КнопкаФормы"), КоманднаяПанель);
...
//++ Матяж А.А. 11.02.2026. Дипломная работа. Добавление процедуры для команды "Заполнить"
&НаКлиенте

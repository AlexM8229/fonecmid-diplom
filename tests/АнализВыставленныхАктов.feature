...
И табличный документ "ОтчетТабличныйДокумент" содержит строки по шаблону:
		...
		| 'ООО Фирма 1'  | 'Договор №1'                      | '1 500,00'              | '51 500,00'          |
		| 'ООО Альфа'    | 'Договор №2'                      | '1 200,00'              | '60 000,00'          |
		| 'ООО Стиль'    | 'Договор №3'                      | '1 000,00'              | ''                   |
		| 'ООО Стиль'    | 'Договор №5'                      | '1 600,00'              | '79 400,00'          |
		| 'ИП Иванов АН' | 'Договор №3'                      | '2 000,00'              | ''                   |
		| 'ООО Русь'     | 'Договор №4'                      | '2 500,00'              | ''                   |
		| 'ИП Иванов АН' | 'Договор №4'                      | ''                      | '51 500,00'          |
